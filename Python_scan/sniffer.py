from scapy.all import Ether, IP, TCP, ICMP, sniff
import time #I used WinPcap and Npcap, these libraries let me take advatage of scapy on a windows machine that I am using
